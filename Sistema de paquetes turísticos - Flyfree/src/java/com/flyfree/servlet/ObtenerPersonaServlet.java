 ...
 * @author andra
 */
public class ObtenerPersonaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            listaPersonas = new PersonaData().mostrarPersonas();
           // JOptionPane.showMessageDialog(null,"entro" );
        }catch(SQLException ex){
            Logger.getLogger(ObtenerPersonaServlet.class.getName()).log(Level.SEVERE, null, ex);
