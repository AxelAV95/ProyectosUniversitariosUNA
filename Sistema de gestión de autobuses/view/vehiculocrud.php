		...
		<div class="row">
			...
			<table class="display">
				...
				<form method="POST" name="vehiculoform" id="vehiculoform" action="../business/vehiculoAction.php">
					<tr>	
						<td><input maxlength="15" required name="placa" type="text"  placeholder="Placa del vehiculo" value="<?php echo !empty($placa)?$placa:'';?>">
						</td>
						<td><input maxlength="15" required name="marca" type="text"  placeholder="Marca" value="<?php echo !empty($marca)?$marca:'';?>">
						</td>
						<td><input maxlength="15" required name="modelo" type="text"  placeholder="Modelo" value="<?php echo !empty($modelo)?$modelo:'';?>">
						</td>
						<td>
						...
						<td><input required id="capacidad" name="capacidad" type="number"  placeholder="Capacidad" value="<?php echo !empty($capacidad)?$capacidad:'';?>">
						</td>
