    ...
    <section id="form">
        <table>
            ...
            foreach ($mangas as $current) {
                ...
                echo '<input type="hidden" name="mangaid" value="' . $current['tomoid'] . '">';
                echo '<tr>';
                echo '<td><input type="text" name="nombre" value="' . $current['tomonombre'] . '"/></td>';
                echo '<td><input type="number" name="numerotomo" value="' . $current['tomonumero']. '"/></td>';
                echo '<td><input type="number" name="anio" value="' . $current['tomoanio'] . '"/></td>';
