...
if (isset($_POST['update'])) {
    ...
    if (isset($_POST['nombre']) && isset($_POST['numerotomo']) && isset($_POST['anio']) && isset($_POST['generos'])  ) {
        $nombre = $_POST['nombre'];
        $tomo = $_POST['numerotomo'];
        $anio = $_POST['anio'];
        ...
        if (strlen($nombre) > 0 && strlen($tomo) > 0 && strlen($anio)) {
             ...
             $manga->setGeneros( trim($cadenagenerosid,','));
             $mangaBusiness = new MangaBusiness();
...
}else if (isset($_POST['actualizarGeneros'])) {
    if (isset($_POST['mangaid']) && isset($_POST['generos'])  ) {
        ...
        $mangaBusiness = new MangaBusiness();
        $result = $mangaBusiness->actualizarGeneros(trim($cadenagenerosid,','),$mangaid);
