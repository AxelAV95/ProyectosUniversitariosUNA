                ...
                <div class="col s12 m12">
                   <div class="card blue-grey darken-1" style="width: auto;">
                       <div class="card-content white-text" >
                           <span class="card-title" style="margin-bottom: 70px;"><h1>Previstas</h1></span>
                           <button id="myBtn" style="margin-bottom: 30px; background: #333; font-size: 23px; font-weight: bolder;">Registrar prevista</button>
                  ...
                  <thead>
                   ...
                   $sql = 'SELECT * FROM tbprevista';
                   foreach ($pdo->query($sql) as $row) {
                    echo '<form  method="post" enctype="multipart/form-data" action="../business/previstaaction.php">';
                    echo '<input type="hidden" name="id" value="' . $row['previstaid'] . '">';

                            echo '<tr>';
                            echo '<td>'. $row['previstaid'] . '</td>';
                            echo '<td>'.  getNombreCliente($pdo,$row['previstaclienteid']).'</td>';
                            echo '<td>'.  getApellido1Cliente($pdo,$row['previstaclienteid']).'</td>';
                            echo '<td>'.  getApellido2Cliente($pdo,$row['previstaclienteid']).'</td>';
                            echo '<td>'. $row['previstasaldoanterior'] . '</td>';
                            echo '<td>'. $row['previstaabonoactual'] . '</td>';
                            echo '<td>'. $row['previstasaldoactual'] . '</td>';
                            ...
                            echo '<td><a class="bVer" onclick="verPrevista(' . $row['previstaclienteid']. ')"></a></td>';
                            echo '<td><a class="bActualizar" onclick="actualizaPrevista(' . $row['previstaid'] . ')" ></a></td>';
                            echo '<td><div name="eliminar" class="bEliminar" id="'.$row['previstaid'].'" ></div></td>';
                 ...
                 <button id="cobroprevista" onclick="window.location.href='historicoprevistaview.php'" style="margin-bottom: 30px; background: #333; font-size: 23px; font-weight: bolder;font-family:Quicksand"class="pure-button pure-button-primary" >Historial de cobros previstas</button>  
            </div>
           </div>
