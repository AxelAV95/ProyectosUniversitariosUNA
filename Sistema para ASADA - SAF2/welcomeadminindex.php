...
<link rel="stylesheet" type="text/css" href="view/css/tooltipster/dist/css/tooltipster.main.css" />
<link rel="stylesheet" type="text/css" href="view/css/tooltipster/dist/css/plugins/tooltipster/sideTip/themes/tooltipster-sideTip-punk.min.css" />
<script type="text/javascript" src="view/css/tooltipster/dist/js/tooltipster.bundle.min.js"></script>
...
<body style="">
  <div id="contenedor_carga">
   ...
   <header>
    ...
    <div style="display: flex; flex-direction: row; margin-left: 84%; margin-top: -20px;">
      <img class="tooltip" title="Guía del sistema"  style="margin-top: -3px; margin-right: 10px;" src="view/css/imagenes/tutorial.png" height="35px" width="35px">

      <a class="tooltip" title="Documentos del sistema"  id="docs" href="view/Documentos/"><i style="font-size: 35px; color: white;" class="fa fa-folder" aria-hidden="true"></i></a>

      <a class="tooltip" title="Configuración básica del sistema" href="test6.php" rel="modal:open"><i style="font-size: 35px; color: white; margin-left: 10px; margin-right: 10px;" class="fa fa-cog" aria-hidden="true"></i></a>
      <div style="display: flex;flex-direction: row-reverse;">
         <img style="margin-top: -11px; " src="view/css/imagenes/agua.png" height="50px" width="50px">
         <h4 style="color: white; margin-top: 3px;">ASADA Finca 2</h4>
    ...
    <div  style="  box-shadow: 2px 0px;" id="content-menu" class="content-menu " >
      ...
      <a style="text-decoration:none;" href="view/adminindex.php"><li  ><i class="fa fa-home fa-2x " aria-hidden="true"></i><h4 class="text1">Inicio</h4></li></a>
      <a style="text-decoration:none;" href="view/empleadoview.php"><li ><i class="fa fa-users  fa-2x" aria-hidden="true"></i></span><h4 class="text1">Empleados</h4></li></a>
      ...
      <a style="text-decoration: none" href="view/usuarioview.php"><li ><i class="fa fa-user-o fa-2x" aria-hidden="true"></i><h4 class="text1">Usuarios</h4></li></a>
      ...
      <a style="text-decoration:none;" href="login/logout.php"><li ><i class="fa fa-sign-out  fa-2x" aria-hidden="true"></i></span><h4 class="text1">Cerrar sesión</h4></li></a>
